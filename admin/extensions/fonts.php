...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'advanced-magazine' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'advanced-magazine' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'advanced-magazine' ),
		'cyrillic'     => __( 'Cyrillic', 'advanced-magazine' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'advanced-magazine' ),
		'devanagari'   => __( 'Devanagari', 'advanced-magazine' ),
		'greek'        => __( 'Greek', 'advanced-magazine' ),
		'greek-ext'    => __( 'Greek Extended', 'advanced-magazine' ),
		'khmer'        => __( 'Khmer', 'advanced-magazine' ),
		'latin'        => __( 'Latin', 'advanced-magazine' ),
		'latin-ext'    => __( 'Latin Extended', 'advanced-magazine' ),
		'vietnamese'   => __( 'Vietnamese', 'advanced-magazine' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'advanced-magazine' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'advanced-magazine' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'advanced-magazine' ),
